...
*/
/**********CURENTLY WORKING ON****************//*
    WORKING:    working on getting the back of the card in the top table to go back to the pack after it is used
        REMEBER:    add back toptab.appendChild(p2cardback[0]);

    ISSUE:      the appendchild function is saying that im giving it a null value in the lessen_p2deck function
...
let topb0 = document.getElementById("topback0");
let topb1 = document.getElementById("topback1");
let topb2 = document.getElementById("topback2");
let topb3 = document.getElementById("topback3");
let topb4 = document.getElementById("topback4");
let topb5 = document.getElementById("topback5");
let topb6 = document.getElementById("topback6");
let topb7 = document.getElementById("topback7");
let topb8 = document.getElementById("topback8");
let topb9 = document.getElementById("topback9");
let topb10 = document.getElementById("topback10");
let topb11 = document.getElementById("topback11");
let topb12 = document.getElementById("topback12");
let topb13 = document.getElementById("topback13");
let topb14 = document.getElementById("topback14");
let topb15 = document.getElementById("topback15");
...
function p1anotherrandpick(){
    console.log('the bew pick is working 2');
...
function p2_move_back_mchanics(temp_back_move_back){
    temp_back_move_back.style.left = '1000px';
};
...
function lessen_p2deck(){
    ...
    while(!p2cardback[p2cardback.length-val]){
        val++
    ...
    p2_move_back_mchanics(temp_move_back);

    lefttab.appendChild(p2cardback[p2cardback.length-val]);
    p2cardback.splice(p2cardback[p2cardback.length-val]);
...
function p2_spread_back_imgs(){
    ...
    var spread_cards_2 = setInterval(function(){
        ...
        topb0.style.left = top_bmove1 + 'px';
        topb1.style.left = top_bmove2 + 'px';
        topb2.style.left = top_bmove3 + 'px';
        topb3.style.left = top_bmove4 + 'px';

        topb0.style.top = '25px';
        topb1.style.top = '25px';
        topb2.style.top = '25px';
        topb3.style.top = '25px';
...
function p2_shrink_moving_start_img(){
    ...
    var p2_shrink_card = setInterval(function(){
        ...
        topb0.style.height = p2_strt_move_height + 'px';
        topb1.style.height = p2_strt_move_height + 'px';
        topb2.style.height = p2_strt_move_height + 'px';
        topb3.style.height = p2_strt_move_height + 'px';

        topb0.style.width = p2_strt_move_width + 'px';
        topb1.style.width = p2_strt_move_width + 'px';
        topb2.style.width = p2_strt_move_width + 'px';
        topb3.style.width = p2_strt_move_width + 'px';
...
function top_back_distribution(){
    ...
    var spread_topb = setInterval(function(){
        ...
        topb0.style.top = topb_hor + 'px';
        topb1.style.top = topb_hor + 'px';
        topb2.style.top = topb_hor + 'px';
        topb3.style.top = topb_hor + 'px';

        topb0.style.left = topb_ver + 'px';
        topb1.style.left = topb_ver + 'px';
        topb2.style.left = topb_ver + 'px';
        topb3.style.left = topb_ver + 'px';
        ...
        if(topb_hor === - 181){
            ...
            let left_top_adjust = setInterval(function(){
                ...
                if(topb_ver = 375){
                    ...
                    toptab.appendChild(p2cardback[0]);
                    toptab.appendChild(topb1);
                    toptab.appendChild(topb2);
                    toptab.appendChild(topb3);
